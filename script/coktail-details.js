...
function addEventListener (cocktailDrinks) {
    ...
    if(index > -1) {
        isLikeActive = true;
        document.querySelector("#like").src = "resource/like.png";
    }
    ...
    document.querySelector("#like").addEventListener("click", function favCocktails() {
        ...
        if(isLikeActive) {
            ...
            localStorage.setItem('favCocktails', JSON.stringify(favCocktails));
            document.querySelector("#like").src = "resource/like-disabled.png"; 
        }
    }); 
...
function showCocktailDetails(response) {
    ...
    germanFlag.src = "resource/british-flag.png";
    germanFlag.id = "british-flag";
    britishFlag.src = "resource/german-flag.png";
    ...
    like.src = "resource/like-disabled.png";
    like.id = "like";
...
function makeSearchRequest() {
    apiUrl = "https://www.thecocktaildb.com/api/json/v1/1/lookup.php?i=" + selectedParameter;
    ...
    .then((cocktails) => {
        showCocktailDetails(cocktails.drinks);
        addEventListener(cocktails.drinks);
    });
}
